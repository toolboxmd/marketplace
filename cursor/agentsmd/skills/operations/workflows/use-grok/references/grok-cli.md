...
This is a working reference for Grok CLI 1.0.5. Read it only when the default invocation in `index.md` is insufficient. If the installed version differs or an option fails, run `grok --help` and `grok models` and prefer the live interface.
