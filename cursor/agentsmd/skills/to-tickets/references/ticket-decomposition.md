...
For direct `to-tickets` entry, use the conversation already in context. Fetch full
...
For `to-spec` continuation, use its verified parent and full current request;
